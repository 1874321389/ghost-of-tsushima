...
namespace Tutorial303
{
    public class GrassMesh
    {
        public static Mesh CreateHighLODMesh()
        {
            ...
            {
                new Vector3(0.000000f, 0.155990f, 0.03445f),
                new Vector3(0.000000f, 0.000000f, -0.03444f),
                new Vector3(0.000000f, 0.000000f, 0.03444f),
                new Vector3(0.000000f, 0.155990f, -0.03445f),
                new Vector3(0.000000f, 0.272490f, -0.03193f),
                new Vector3(0.000000f, 0.272490f, 0.03193f),
            ...
            mesh.RecalculateBounds(); //生成包围盒
            mesh.RecalculateNormals(); //根据三角面法线自动插值
            mesh.RecalculateTangents(); //生成切线
